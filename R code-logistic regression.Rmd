...
plot_decision_curve(modelt,curve.name=c('Logistic Regression'),xlim=c(0,0.8),ylim=c(0,0.2),
...
```{r}
library(tidyverse)
tiff(filename="zhifangtu-Xgbc22.tif", width=800*6, height=400*6, res=90*6)
