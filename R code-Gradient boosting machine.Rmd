...
plot_decision_curve(modelt,curve.name=c('Gradient Boosting Machine'),xlim=c(0,0.8),ylim=c(0,0.2),
...
tiff(filename="xiangshitu-Gradient Boosting Machine2.tif", width=800*6, height=600*6, res=90*6)
