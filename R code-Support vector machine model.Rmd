...
plot_decision_curve(modelt,curve.name=c('Support Vector Machine'),xlim=c(0,0.8),ylim=c(0,0.2),
...
legend(0.55,0.35,
       ...
       bty="n")
title(paste("Support Vector Machine"))
dev.off()
```
...
ggplot(data=star,aes(x = anxietyanddepression, y =lr_pred_proba)) +
  ...
  scale_fill_manual(values=c("green", "red"))+
    ggtitle(paste("Support Vector Machine, Discrimination Slope=", 
